...
$string['err_cannot_uninstall_plugin_reason'] = 'The plugin {$a->plugin} cannot be uninstalled: {$a->reason}';
...
$string['uninstall_commoncheck'] = 'This plugin cannot be uninstalled due to internal checks.';
$string['uninstall_dependency'] = 'This plugin is required by: {$a}.';
$string['uninstall_notinstalled'] = 'This plugin is not installed.';
$string['uninstall_reason_legacy_uninstall_url_null'] = 'This plugin uses a deprecated uninstall method: plugininfo subclasses should use is_uninstall_allowed() instead of returning null in get_uninstall_url().';
$string['uninstall_reason_notallowed_authusers'] = 'This auth method is used by at least one user.';
$string['uninstall_reason_notallowed_inuse'] = '{$a} is being used.';
$string['uninstall_reason_notallowed_linkedquestionattempts'] = '{$a} is linked to existing question attempts.';
$string['uninstall_reason_notallowed_plugininfo'] = 'This plugin declares that it cannot be uninstalled.';
$string['uninstall_reason_notallowed_qtypeexists'] = '{$a} is linked to existing questions.';
$string['uninstall_reason_notallowed_required'] = '{$a} is required by Moodle.';
$string['uninstall_reason_notinstalled'] = 'The plugin is not installed. It should be either installed or removed from the disk.';
$string['uninstall_reason_uninstallclionly'] = 'Web uninstall is disabled. You must uninstall via the command line.';
$string['uninstall_subplugin_dependency'] = 'A subplugin is required by: {$a}.';
